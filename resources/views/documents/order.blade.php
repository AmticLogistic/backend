...
<body>
    <header>
        <table style="width:100%;border:none">
            <tr>
                ...
                <td>
                    <div class="box2">
                        <h4 class="center" style="font-size:16px">ORDEN DE COMPRA</h4>
    ...
    <table style="width:100%; margin: 70px 0px 10px 0px; font-size:11px">
        <thead>
            ...
            <tr>
                ...
                <td class="left">{{ $data->ruc }}</td>
                <th width="100" class="left">Fecha de entrega: </th>
                <td class="left">{{ $data->fecha }}</td>
            </tr>
            <tr>
                <th class="left">Dirección: </th>
                <td colspan="3">{{ $data->direccionFiscal }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="left">Sitio de Entrega: </th>
                <td colspan="3">{{ $data->sitioEntrega }}</td>
            </tr>
            <tr>
    ...
    <table style="width:100%; margin: 20px 0px 10px 0px; font-size:11px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid black;">&nbsp;{{ number_format($gravado, 2) }}</td>
            </tr>
            <tr>
    ...
    <table style="width:35%; font-size:11px">
        <tr>
            <td style="padding: 20px;width:200px">
                <div style="border: 1px solid black; border-radius: 12px">
                    ...
                    <p style="padding-left:8px;text-align: center;"> {{ $data->revisadoPor }} <br> Logística </p>
                    <hr>
            ...
            <td style="padding: 20px;width:200px">
                <div style="border: 1px solid black; border-radius: 12px">
                    <p style="padding-left:8px;text-align:center;font-weight: 700">Aprovado por:</p>
                    <hr>
                    <p style="font-weight: 600;padding-left:8px">Nombre/función</p>
                    <p style="padding-left:8px;text-align: center;"> {{ $data->aprobadoPor }} <br> Gerente </p>
                    <hr>
                    <p style="padding-left:8px">Firma: <br> <br><br><br>
                </div>
            </td>
            <td style="padding: 20px;width:200px">
                <div style="border: 1px solid black; border-radius: 12px">
                    <p style="padding-left:8px;text-align:center;font-weight: 700">Aprobado por Proveedor:</p>
                    <hr>
                    <p style="font-weight: 600;padding-left:8px">Nombre/función</p>
                    <p style="padding-left:8px;text-align: center;"> {{ $data->empresa }} </p>
                    <hr>
                    <p style="padding-left:8px">Firma: <br> <br><br><br>
                </div>
            </td>
    ...
    <table style="width:100%; margin: 20px 0px 10px 0px; font-size:11px">
        <thead>
            <tr>
                <th class="border" colspan="2">DATOS DE FACTURACIÓN</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <th class="left">Razon Social</th>
                <td class="">SERVICIOS GENERALES AMARU DEL SUR S.A.C.</td>
            </tr>
            <tr>
                <th class="left">RUC</th>
                <td class="">20608024167</td>
            </tr>
            <tr>
                <th class="left">Dirección Fiscal</th>
                <td class="">URB. VILLA LOS ANGELES MZ.R LT.1</td>
            </tr>
        </tbody>
    </table>
</body>
