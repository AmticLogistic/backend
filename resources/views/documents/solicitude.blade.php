...
<body>
    <header>
        <table style="width:100%;border:none">
            <tr>
                ...
                <td>
                    <div class="box2">
                        <h4 class="center" style="font-size:16px">SOLICITUD DE COTIZACIÓN</h4>
    ...
    <table style="width:40%; font-size:11px; float:right">
        <tr>
            <td style="padding: 20px;">
                <div style="border: 1px solid black; border-radius: 12px">
                    ...
                    <p style="padding-left:8px;text-align: center;font-size:9px">{{ $data->user }}</p>
                    <hr>
